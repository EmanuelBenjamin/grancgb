...
public class MaterialesService {
    private static final String BASE_URL ="htpp://localhost:8080/CGB-BanReservas/gen Materiales/";
    
    private String name;
    private String description;
    private double price;

    public MaterialesService(String name, String description, double price) {
        this.name = name;
